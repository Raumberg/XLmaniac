...
body_style = {
    ...
    'padding': 20,
    'border_radius': 10,
    'bgcolor': ft.colors.with_opacity(0.045, 'white70'), 
    'shadow': ft.BoxShadow(
        spread_radius=20,
        blur_radius=45,
        ...
        self.content = ft.Column(
            controls=[
                ...
                ft.Row(controls=[
                    ...
                    ft.Text('Build: ' + BUILD_VERSION, size=20, color=ft.colors.with_opacity(0.8, ft.colors.BLUE_800), weight=ft.FontWeight.W_900, italic=False, text_align='right')
                ]),
            ]
        )
